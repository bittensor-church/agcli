...
// ──────────────────────────────────────────────────────────────────────────────
// Parse-surface: safe-mode force-enter (no --duration; pallet sets duration)
// ──────────────────────────────────────────────────────────────────────────────

#[test]
fn parse_safe_mode_force_enter_parses() {
...
#[test]
fn parse_safe_mode_force_enter_rejects_duration_flag() {
    let cli =
...
// ──────────────────────────────────────────────────────────────────────────────
// `force-enter` no longer accepts `--duration`; duration is set by chain config.
// ──────────────────────────────────────────────────────────────────────────────

#[test]
fn force_enter_has_no_duration_flag() {
    let cli = agcli::cli::Cli::try_parse_from(["agcli", "safe-mode", "force-enter"]);
    assert!(cli.is_ok());
    assert!(matches!(
        cli.unwrap().command,
